...
def main():
    ...
    try:
        ...
        data.write_value(bs)
        time.sleep(0.1)
        bs = b'\x00\x0e\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00'
        data.write_value(bs)
        time.sleep(0.1)
        ...
        data.write_value(bs)
        time.sleep(0.1)
        bs = b'\x00\x00\x7e\x18\x18\x18\x18\x18\x18\x18\x00\x00\x00\xfe\xc0\xc0'
        data.write_value(bs)
        time.sleep(0.1)
        bs = b'\xfe\xc0\xc0\xc0\xfe\x00\x00\x00\xfe\xc6\xc6\xfe\xc6\xc6\xc6\xc6'
        data.write_value(bs)
        time.sleep(0.1)
        bs = b'\x00\x00\x00\xc6\xee\xfe\xd6\xc6\xc6\xc6\xc6\x00\x00\x00\x00\x00'
        data.write_value(bs)
        time.sleep(0.1)
        bs = b'\x00\x00\x00\x00\x00\x00\x00\x00\x00\xc6\xe6\xe6\xf6\xde\xce\xce'
        data.write_value(bs)
        time.sleep(0.1)
        bs = b'\xc6\x00\x00\x00\xfe\xc6\xc6\xc6\xc6\xc6\xc6\xfe\x00\x00\x00\xfe'
        data.write_value(bs)
        time.sleep(0.1)
        bs = b'\xc6\xc6\xfe\xd8\xcc\xc6\xc6\x00\x00\x00\xfe\xc6\xc6\xfe\xc6\xc6'
        data.write_value(bs)
        time.sleep(0.1)
        bs = b'\xc6\xc6\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00'
        data.write_value(bs)
        time.sleep(0.1)
        bs = b'\xc6\xc6\xc6\xfe\xc6\xc6\xc6\xc6\x00\x00\x00\xfe\xc6\xc6\xfe\xc6'
        data.write_value(bs)
        time.sleep(0.1)
        bs = b'\xc6\xc6\xc6\x00\x00\x00\xfe\xc6\xc0\xc0\xc6\xc6\xc6\xfe\x00\x00'
        data.write_value(bs)
        time.sleep(0.1)
        bs = b'\x00\xc6\xcc\xd8\xf0\xd8\xcc\xc6\xc6\x00\x00\x00\x00\x00\x00\x00'
        data.write_value(bs)
        time.sleep(3)
        print('Writing done.')
    finally:
