...
# misaki fonts for NORA Badge
fontpath = "./misaki_gothic.ttf"
#fontpath = "./misaki_gothic_2nd.ttf"
#fontpath = "./misaki_mincho.ttf"
draw.font = ImageFont.truetype(fontpath, 8)
draw.text((0,2), text, (255, 255, 255))
